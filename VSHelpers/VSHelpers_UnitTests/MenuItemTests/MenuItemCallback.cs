...
namespace VSHelpers_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSHelpersPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(BD.VSHelpers.GuidList.guidVSHelpersCmdSet, (int)BD.VSHelpers.PkgCmdIDList.cmdidCopyWithContext);
